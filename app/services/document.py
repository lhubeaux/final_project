    ...
    for para in segment(texte):
        ...
        for phrase in para["phrases"]:
            ...
            phrases.append(Sentence(
                texte=phrase["texte"], start=phrase["start"],
                end=phrase["end"], tokens=tokens,
            ))
        paragraphes.append(Paragraph(
            texte=para["texte"], start=para["start"],
            end=para["end"], phrases=phrases,
        ))
